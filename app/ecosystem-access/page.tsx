    ...
    <div className="min-h-screen bg-white text-gray-900 font-light">
          ...
          <div className="space-y-16">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <Card className="border-0 shadow-lg">
                ...
                <CardContent>
                  <p className="text-gray-600 font-light mb-4">
                    We don’t just advise. We do. Get hands-on support from our curated pool of 'Executioners' — a unique
                    blend of ex-founders and domain experts.
                  </p>
                  <div className="bg-gray-50 p-4 rounded-none mb-4">
                    <p className="font-medium text-gray-800 flex items-center">
                      <CheckCircle className="h-4 w-4 mr-2 text-green-500" />4 hours/month of Execution Support included
                    </p>
                  </div>
              ...
              <Card className="border-0 shadow-lg">
                ...
                <CardContent>
                  <p className="text-gray-600 font-light mb-4">
                    Your access includes time with curated mentors covering fundraising prep, product roadmapping, team
                    building, and founder wellbeing.
                  </p>
                  <div className="bg-gray-50 p-4 rounded-none mb-4">
                    <p className="font-medium text-gray-800 flex items-center">
              ...
              <Card className="border-0 shadow-lg">
                ...
                <CardContent>
                  <p className="text-gray-600 font-light text-sm">
                    Connect with mindset-aligned freelancers for UI/UX, web dev, content, branding, CRM, and more. We’ve
                    done the vetting, you just plug and play.
                  </p>
                </CardContent>
              </Card>
      ...
      <section className="py-24 px-4 md:px-6">
        <div className="container mx-auto max-w-3xl text-center">
          <h2 className="text-3xl md:text-4xl font-extralight text-gray-900 mb-4">🔗 Ready to Plug Into the Tribe?</h2>
